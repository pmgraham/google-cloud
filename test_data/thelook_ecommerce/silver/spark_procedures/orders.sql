CREATE OR REPLACE PROCEDURE `biglake-pipeline-test1.silver.transform_orders`()
...
bq_client.query("EXPORT TABLE METADATA FROM `biglake-pipeline-test1.silver.orders`").result()
""";
