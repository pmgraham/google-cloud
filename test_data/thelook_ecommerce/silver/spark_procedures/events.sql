CREATE OR REPLACE PROCEDURE `biglake-iceberg-datalake.silver.transform_events`()
...
bq_client.query("EXPORT TABLE METADATA FROM `biglake-iceberg-datalake.silver.events`").result()
""";
