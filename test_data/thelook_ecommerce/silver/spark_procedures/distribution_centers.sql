CREATE OR REPLACE PROCEDURE `biglake-iceberg-datalake.silver.transform_distribution_centers`()
...
bq_client.query("EXPORT TABLE METADATA FROM `biglake-iceberg-datalake.silver.distribution_centers`").result()
""";
