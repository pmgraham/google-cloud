CREATE OR REPLACE PROCEDURE `biglake-pipeline-test1.silver.transform_order_items`()
...
bq_client.query("EXPORT TABLE METADATA FROM `biglake-pipeline-test1.silver.order_items`").result()
""";
