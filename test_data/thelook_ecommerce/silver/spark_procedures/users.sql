CREATE OR REPLACE PROCEDURE `biglake-iceberg-datalake.silver.transform_users`()
...
bq_client.query("EXPORT TABLE METADATA FROM `biglake-iceberg-datalake.silver.users`").result()
""";
